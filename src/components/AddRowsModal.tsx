...
const AddRowsModal: React.FC<AddRowsModalProps> = ({ isOpen, onClose, onConfirm }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div className="relative bg-white rounded-xl shadow-[0_20px_25px_-5px_rgba(0,0,0,0.1),0_10px_10px_-5px_rgba(0,0,0,0.04)] w-full max-w-[380px] overflow-hidden animate-in zoom-in-95 duration-200">
