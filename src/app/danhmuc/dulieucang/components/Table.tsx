...
export default function DataTable<T extends object>({
  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white shadow-sm">
      <style>
        {`
          .gtos-table .ant-table-thead > tr > th {
            background: #d0ebff;
            color: #1c7ed6;
            font-weight: 600;
          }
          .gtos-table :where(.ant-table-thead > tr > th) {
            border-inline-end: none !important;
          }
          .gtos-table .ant-table-container,
          .gtos-table .ant-table-header,
          .gtos-table .ant-table-content {
          ...
          .gtos-table .ant-table-container table {
            border-collapse: collapse !important;
            border-spacing: 0 !important;
          }
          .gtos-table .ant-table-thead th.ant-table-column-has-sorters:hover,
          .gtos-table .ant-table-thead th.ant-table-column-has-sorters:focus {
